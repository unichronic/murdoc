...
DEFAULT_POLICY_VERSION = os.getenv("AGENTVAULT_POLICY_VERSION", "agentvault-local-v1")
DEFAULT_CONFIG_VERSION = os.getenv("AGENTVAULT_CONFIG_VERSION", "local-default-v1")
DEFAULT_CONTROL_PLANE_FILE = os.getenv("AGENTVAULT_CONTROL_PLANE_FILE", "").strip()
DEFAULT_DECISION_LEDGER_FILE = os.getenv("AGENTVAULT_DECISION_LEDGER_FILE", "").strip()
DEFAULT_RUNTIME_SETTINGS_FILE = os.getenv("AGENTVAULT_RUNTIME_SETTINGS_FILE", "").strip()
...
def _default_gateway_routes() -> dict[str, GatewayRoute]:
    ...
    default_llm = os.getenv("AGENTVAULT_DEFAULT_LLM_UPSTREAM_URL", "").strip()
    if default_llm:
...
class GatewayRouteStore:
    ...
    def __init__(self, config_file: str = os.getenv("AGENTVAULT_GATEWAY_ROUTES_FILE", "").strip()):
        self.config_file = config_file
