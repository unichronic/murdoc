...
BIFROST_READ_CACHE_ENABLED = os.getenv("BIFROST_READ_CACHE_ENABLED", "true").lower() == "true"
BIFROST_READ_CACHE_MAX_ITEMS = int(os.getenv("BIFROST_READ_CACHE_MAX_ITEMS", "256"))
BIFROST_READ_CACHE_TTL_SECONDS = int(os.getenv("BIFROST_READ_CACHE_TTL_SECONDS", "300"))
