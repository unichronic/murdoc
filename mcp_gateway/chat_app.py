...
Interactive chat application that connects to Notion via MCP.
Provides a REPL-style interface for continuous conversation with
Notion workspace through the AI model.

Architecture:
  User ─► Bifrost Gateway (security) ─► This Chat App ─► Notion MCP Server
"""
...
async def main():
    ...
    print("=" * 60)
    print("  Notion MCP Chat — Interactive AI ↔ Notion")
