...
func (m *Middleware) PostLLMHook(ctx *schemas.AgentVaultContext, req *schemas.AgentVaultChatRequest, resp *schemas.AgentVaultChatResponse, _ interface{}) *schemas.HookResult {
